...
class ProcessedFilesDialog(QDialog):
    ...
    def _select_output_folder(self) -> None:
        ...
        if self.db_manager is None or self.db_manager.oversight_and_defaults is None:
            return
        ...
        output_folder = QFileDialog.getExistingDirectory(
            self, "Select Output Folder", initial_dir, QFileDialog.Option.ShowDirsOnly
        )
    ...
    def _on_export(self) -> None:
        ...
        if not self._selected_folder_id or not self._output_folder:
            QMessageBox.warning(
                self, "Warning", "Please select a folder and output folder first."
            )
            return
        ...
        try:
            ...
            base_path = os.path.join(
                self._output_folder, f"{folder_alias} processed report"
            )
            ...
            QMessageBox.information(
                self, "Success", f"Exported {count} records to:\\n{output_path}"
            )
