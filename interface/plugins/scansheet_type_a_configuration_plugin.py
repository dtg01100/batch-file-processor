...
Provides support for ScanSheet Type A-specific configuration fields and validation.
"""
...
class ScanSheetTypeAConfiguration:
    """ScanSheet Type A configuration data class."""
...
class ScanSheetTypeAConfigurationPlugin(ConfigurationPlugin):
    ...
    def get_description(cls) -> str:
        ...
        return "Provides ScanSheet Type A format configuration options for EDI conversion"
    ...
    def deserialize_config(self, data: Dict[str, Any]) -> ScanSheetTypeAConfiguration:
