...
def upgrade_database(database_connection, config_folder, running_platform):
    ...
    if db_version_dict['version'] == '23':
        ...
        database_connection.query("alter table 'folders' add column 'invoice_date_custom_format'")
        database_connection.query('UPDATE "folders" SET "invoice_date_custom_format" = 0')
        database_connection.query("alter table 'administrative' add column 'invoice_date_custom_format'")
    ...
    if db_version_dict['version'] == '31':
        database_connection.query("alter table 'folders' add column 'fintech_division_id'")
        database_connection.query('UPDATE "folders" set "fintech_division_id"=0')
        database_connection.query("alter table 'administrative' add column 'fintech_division_id'")
