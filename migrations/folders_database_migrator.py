...
def upgrade_database(
    ...
    db_version_dict = run_legacy_migrations(
        database_connection, config_folder, running_platform,
        db_version, db_version_dict, target_version,
    )
    ...
    if str(db_version_dict["version"]) == "32" and target_version is None:
        logger.info("Production database at v32, applying consolidated v33→v50 migration")
