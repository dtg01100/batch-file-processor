...
from webapp.pipeline.interfaces import DatabaseInterface, RunLog
...
from webapp.pipeline.services.progress_reporter import ProgressReporter
...
class DispatchOrchestrator:
    ...
    def process_folder(
        ...
        with CorrelationContext(correlation_id):
            from webapp.pipeline.services.folder_processor import FolderProcessingRequest
