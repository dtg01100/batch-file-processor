...
if TYPE_CHECKING:
    ...
    from webapp.pipeline.pipeline.splitter import SplitterResult
...
from webapp.pipeline.file_utils import extract_invoice_numbers
from webapp.pipeline.interfaces import ErrorHandlerInterface, FileSystemInterface, RunLog
...
class FileProcessor:
    ...
    def _handle_validation_result(
        ...
        """
        from webapp.pipeline.pipeline.validator import normalize_validation_output
    ...
    def _run_splitting(
        ...
        from webapp.pipeline.pipeline.splitter import SplitterResult
        from webapp.pipeline.pipeline.temp_dir_utils import create_pipeline_temp_dir
    ...
    def _send_file(
        ...
        from webapp.pipeline.file_utils import apply_file_rename as _ar
