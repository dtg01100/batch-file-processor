...
Example:
    >>> from webapp.pipeline.pipeline import create_standard_pipeline
...
from webapp.pipeline.pipeline.converter import EDIConverterStep
from webapp.pipeline.pipeline.splitter import EDISplitterStep
from webapp.pipeline.pipeline.validator import EDIValidationStep
from webapp.pipeline.results import DispatchConfig
