...
CONVERTER_METADATA = {
    ...
    "module_name": "webapp.pipeline.converters.convert_to_stewarts_custom",
}
...
from webapp.pipeline.converters.customer_queries import STEWARTS_CUSTOMER_QUERY_SQL
...
class StewartsCustomConverter(BaseEDIConverter):
    ...
    def process_a_record(self, record: EDIRecord, context: ConversionContext) -> None:
        ...
        assert (
            self._customer_service is not None
