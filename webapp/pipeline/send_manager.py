...
from webapp.pipeline.interfaces import BackendInterface
...
class SendManager:
    ...
    def send_all(
        self, enabled_backends: set[str], file_path: str, params: dict, settings: dict
    ) -> dict[str, bool]:
    ...
    def _send_to_backend(
        self, backend_name: str, file_path: str, params: dict, settings: dict
    ) -> bool:
