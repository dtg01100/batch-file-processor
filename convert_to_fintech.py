...
class FintechConverter(CSVConverter):
    """Converter for Fintech format CSV output with database lookups."""

    PLUGIN_ID = "fintech"
    PLUGIN_NAME = "Fintech CSV"
    PLUGIN_DESCRIPTION = (
        "Fintech format with division ID and database lookups for customer numbers"
    )
    ...
    CONFIG_FIELDS = [
        {
            ...
            "help": "The division identifier to include in all output rows",
        }
    ]
    ...
    def __init__(
        ...
        self.fintech_division_id = self.get_config_value("fintech_division_id", "")
