...
class EDIValidator:
    ...
    def validate_file(self, input_file: str, file_name: str) -> ValidationResult:
        """
        ...
        try:
            ...
            if minor_edi_errors or (edi_validator_error_status and True):  # reporting['report_edi_errors']
            ...
            return ValidationResult(
                ...
                error_message=edi_validator_output.getvalue() if edi_validator_error_status else "",
