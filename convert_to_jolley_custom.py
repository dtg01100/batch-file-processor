"""Converter for Jolley Custom format CSV output.
...
- Line items (Description, UPC, Quantity, UOM, Price, Amount)
...
class JolleyCustomConverter(DBEnabledConverter):
    """Converter for Jolley Custom format CSV output.

    This converter produces a multi-section CSV file with invoice details,
    billing/shipping addresses, and line item information. It requires
    ...
    - Line items with description, UPC, quantity, UOM, price, and amount
    ...
    Attributes:
        ...
        csv_dialect: Override to use 'unix' dialect for Jolley format.
        lineterminator: Override to use Unix line endings.
    """

    PLUGIN_ID = "jolley_custom"
    PLUGIN_NAME = "Jolley Custom Format"
    PLUGIN_DESCRIPTION = "Converter for Jolley Custom format CSV output with invoice details, addresses, and line items"
    ...
    def __init__(
        ...
        """Initialize the Jolley Custom converter.
    ...
    @staticmethod
    def _safe_int_from_invoice(invoice_number: str) -> int:
        """Safely convert invoice number to integer for SQL injection prevention.

        Args:
            invoice_number: The invoice number string to convert.

        Returns:
            Integer value of invoice number, or 0 if conversion fails.
        """
    ...
    def _fetch_customer_data(self, invoice_number: str) -> dict:
        ...
        including customer details, salesperson, terms, and corporate info.
        ...
        # Validate invoice number to prevent SQL injection
        invoice_int = self._safe_int_from_invoice(invoice_number)
    ...
    SELECT TRIM(dsadrep.adbbtx) AS "Salesperson Name",
        ...
        WHERE ohhst.bthhnb = {invoice_int}
            """
        ...
        # Handle case where corporate customer is not set
    ...
    def _write_invoice_sections(self) -> None:
        ...
        Writes Invoice Details, Bill To, and Ship To sections.
        """
        ...
        # Line item headers
        self.write_row([""])
        self.write_row(["Description", "UPC #", "Quantity", "UOM", "Price", "Amount"])
    ...
    def process_record_b(self, record: dict) -> None:
        ...
        Writes a line item row with description, UPC, quantity, UOM, price, and amount.
...
edi_convert = create_edi_convert_wrapper(JolleyCustomConverter)
