...
class TestConvertToCSV:
    ...
    def test_basic_conversion(
        self, temp_dir, edi_basic, settings_dict, csv_parameters, upc_lookup_basic
    ):
        """Basic EDI to CSV conversion works."""
        output_file = os.path.join(temp_dir, "test_output")

        convert_to_csv.edi_convert(
            edi_basic, output_file, settings_dict, csv_parameters, upc_lookup_basic
        )
    ...
    def test_complex_edi(
        self, temp_dir, edi_complex, settings_dict, csv_parameters, upc_lookup_basic
    ):
        """Complex multi-invoice EDI converts."""
        output_file = os.path.join(temp_dir, "test_complex")

        convert_to_csv.edi_convert(
            edi_complex, output_file, settings_dict, csv_parameters, upc_lookup_basic
        )
...
class TestConvertToFintech:
    ...
    def test_basic_conversion(
        ...
        assert os.path.exists(output_file + ".csv") or os.path.exists(
            output_file + ".txt"
        )
    ...
    def test_complex_edi_conversion(
        self,
        temp_dir,
        edi_complex,
        settings_dict,
    ...
    def test_empty_edi(
        ...
        convert_to_fintech.edi_convert(
            edi_empty, output_file, settings_dict, fintech_parameters, upc_lookup_basic
        )

        assert os.path.exists(output_file + ".csv")

    def test_malformed_edi(
        self,
        temp_dir,
        edi_malformed,
        settings_dict,
    ...
    def test_fintech_parameters_variations(
        self,
        temp_dir,
        edi_fintech,
        settings_dict,
        ...
        convert_to_fintech.edi_convert(
            edi_fintech, output_file + "_1", settings_dict, params1, upc_lookup_basic
        )

        params2 = fintech_parameters.copy()
        params2["include_headers"] = "False"
        convert_to_fintech.edi_convert(
            edi_fintech, output_file + "_2", settings_dict, params2, upc_lookup_basic
        )
...
class TestConvertToScannerware:
    ...
    def test_date_offset_parameter(
        self,
        temp_dir,
        edi_basic,
        settings_dict,
    ...
    def test_scannerware_parameters_variations(
        self,
        temp_dir,
        edi_basic,
        settings_dict,
        ...
        convert_to_scannerware.edi_convert(
            edi_basic, output_file + "_1.txt", settings_dict, params1, upc_lookup_basic
        )
        ...
        convert_to_scannerware.edi_convert(
            edi_basic, output_file + "_2.txt", settings_dict, params2, upc_lookup_basic
        )
        ...
        convert_to_scannerware.edi_convert(
            edi_basic, output_file + "_3", settings_dict, params3, upc_lookup_basic
        )
...
class TestConvertToScansheetTypeA:
    ...
    def test_scansheet_parameters_variations(
        self,
        temp_dir,
        edi_basic,
        settings_dict,
        ...
        params1["a_record_padding"] = "123456"
        convert_to_scansheet_type_a.edi_convert(
            edi_basic, output_file + "_1", settings_dict, params1, upc_lookup_basic
        )
        ...
        params2["include_headers"] = "False"
        convert_to_scansheet_type_a.edi_convert(
            edi_basic, output_file + "_2", settings_dict, params2, upc_lookup_basic
        )
...
class TestConvertToSimplifiedCSV:
    ...
    def test_simplified_csv_parameters_variations(
        self,
        temp_dir,
        edi_basic,
        settings_dict,
        ...
        convert_to_simplified_csv.edi_convert(
            edi_basic, output_file + "_4", settings_dict, params4, upc_lookup_basic
        )
...
class TestConvertToYellowdogCSV:
    ...
    def test_yellowdog_parameters_variations(
        self,
        temp_dir,
        edi_basic,
        settings_dict,
...
class TestConvertToJolleyCustom:
    ...
    def test_basic_conversion(
        ...
        convert_to_jolley_custom.edi_convert(
            edi_basic, output_file, settings_dict, custom_parameters, upc_lookup_basic
        )

        # Jolley custom may create .csv or .txt
        assert (
            os.path.exists(output_file + ".csv")
            or os.path.exists(output_file + ".txt")
    ...
    def test_complex_edi_conversion(
        ...
        convert_to_jolley_custom.edi_convert(
            edi_complex, output_file, settings_dict, custom_parameters, upc_lookup_basic
        )
    ...
    def test_empty_edi(
        ...
        convert_to_jolley_custom.edi_convert(
            edi_empty, output_file, settings_dict, custom_parameters, upc_lookup_basic
        )
    ...
    def test_jolley_custom_parameters_variations(
        self,
        temp_dir,
        edi_basic,
        settings_dict,
        ...
        assert (
            os.path.exists(output_file + "_1.csv")
            or os.path.exists(output_file + "_1.txt")
            or os.path.exists(output_file + "_1")
        )
        assert (
            os.path.exists(output_file + "_2.csv")
            or os.path.exists(output_file + "_2.txt")
            or os.path.exists(output_file + "_2")
        )
...
class TestConvertToStewartsCustom:
    ...
    def test_stewarts_custom_parameters_variations(
        self,
        temp_dir,
        edi_basic,
        settings_dict,
...
class TestConvertToEstoreEinvoice:
    ...
    def test_basic_conversion(
        self, temp_dir, edi_basic, settings_dict, estore_parameters, upc_lookup_basic
    ):
        """Basic EDI to eStore einvoice format works."""
        output_file = os.path.join(temp_dir, "test_output")

        result_file = convert_to_estore_einvoice.edi_convert(
            edi_basic, output_file, settings_dict, estore_parameters, upc_lookup_basic
        )
    ...
    def test_complex_edi_conversion(
        self, temp_dir, edi_complex, settings_dict, estore_parameters, upc_lookup_basic
    ):
        """Complex multi-invoice EDI converts."""
        output_file = os.path.join(temp_dir, "test_complex")

        result_file = convert_to_estore_einvoice.edi_convert(
            edi_complex, output_file, settings_dict, estore_parameters, upc_lookup_basic
        )
    ...
    def test_empty_edi(
        self, temp_dir, edi_empty, settings_dict, estore_parameters, upc_lookup_basic
    ):
        """Empty EDI file handled properly."""
        output_file = os.path.join(temp_dir, "test_empty")

        result_file = convert_to_estore_einvoice.edi_convert(
            edi_empty, output_file, settings_dict, estore_parameters, upc_lookup_basic
        )
    ...
    def test_estore_einvoice_parameters_variations(
        self, temp_dir, edi_basic, settings_dict, estore_parameters, upc_lookup_basic
    ):
        """Different parameter combinations work."""
        output_file = os.path.join(temp_dir, "test_params")
        ...
        result_file_1 = convert_to_estore_einvoice.edi_convert(
            edi_basic, output_file + "_1", settings_dict, params1, upc_lookup_basic
        )
        ...
        result_file_2 = convert_to_estore_einvoice.edi_convert(
            edi_basic, output_file + "_2", settings_dict, params2, upc_lookup_basic
        )
...
class TestConvertToEstoreEinvoiceGeneric:
    ...
    def test_basic_conversion(
        ...
        result_file = convert_to_estore_einvoice_generic.edi_convert(
            edi_basic, output_file, settings_dict, estore_parameters, upc_lookup_basic
        )
    ...
    def test_estore_einvoice_generic_parameters_variations(
        self,
        temp_dir,
        edi_basic,
        settings_dict,
        ...
        params1 = estore_parameters.copy()
        params1["estore_store_number"] = "54321"
        result_file_1 = convert_to_estore_einvoice_generic.edi_convert(
            edi_basic, output_file + "_1", settings_dict, params1, upc_lookup_basic
        )
        ...
        params2 = estore_parameters.copy()
        params2["estore_Vendor_OId"] = "98765"
        result_file_2 = convert_to_estore_einvoice_generic.edi_convert(
            edi_basic, output_file + "_2", settings_dict, params2, upc_lookup_basic
        )
...
class TestAllConvertersRegression:
    ...
    def test_all_modules_importable(self):
        ...
        for converter in converters:
            assert hasattr(converter, "edi_convert"), (
                f"{converter.__name__} missing edi_convert function"
            )

    @pytest.mark.skip(reason="Some converters require database connection")
    def test_complex_edi_all_converters(
        self,
        temp_dir,
        edi_complex,
        settings_dict,
        ...
        convert_to_scannerware.edi_convert(
            edi_complex,
            os.path.join(temp_dir, "scannerware.txt"),
            settings_dict,
            scannerware_parameters,
            upc_lookup_basic,
        )
        ...
        convert_to_scansheet_type_a.edi_convert(
            edi_complex,
            os.path.join(temp_dir, "scansheet.txt"),
            settings_dict,
            scansheet_parameters,
            upc_lookup_basic,
        )
        ...
        convert_to_simplified_csv.edi_convert(
            edi_complex,
            os.path.join(temp_dir, "simplified"),
            settings_dict,
            simplified_csv_parameters,
            upc_lookup_basic,
        )
        ...
        convert_to_yellowdog_csv.edi_convert(
            edi_complex,
            os.path.join(temp_dir, "yellowdog"),
            settings_dict,
            yellowdog_parameters,
            upc_lookup_basic,
        )
        ...
        convert_to_stewarts_custom.edi_convert(
            edi_complex,
            os.path.join(temp_dir, "stewarts"),
            settings_dict,
            custom_parameters,
            upc_lookup_basic,
        )
        ...
        convert_to_estore_einvoice_generic.edi_convert(
            edi_complex,
            os.path.join(temp_dir, "estore_gen"),
            settings_dict,
            estore_parameters,
            upc_lookup_basic,
        )
...
class TestCorpusRegressions:
    ...
    def test_corpus_csv_conversion_010042(
        self, corpus_010042_file, csv_parameters, settings_dict, upc_lookup_basic
    ):
    ...
    def test_corpus_scannerware_conversion_010042(
        self,
        corpus_010042_file,
        scannerware_parameters,
        settings_dict,
    ...
    def test_corpus_simplified_csv_conversion_010042(
        self,
        corpus_010042_file,
        simplified_csv_parameters,
        settings_dict,
    ...
    def test_corpus_sample_variety(self, corpus_sample_files):
        ...
        assert all(os.path.exists(f) for f in corpus_sample_files), (
            "Some corpus files missing"
        )
...
class TestConvertToCSVPaths:
    ...
    def test_pad_a_records_applies_padding(self, csv_parameters, settings_dict):
        ...
        out_file = convert_to_csv.edi_convert(
            temp_file, os.path.join(temp_dir, "out"), settings_dict, params, {}
        )
    ...
    def test_retail_uom_overrides_upc_and_calculates_quantities(
        self, csv_parameters, settings_dict
    ):
        ...
        out_file = convert_to_csv.edi_convert(
            temp_file, os.path.join(temp_dir, "out"), settings_dict, params, upc_lut
        )
    ...
    def test_invalid_record_produces_empty_output(self, csv_parameters, settings_dict):
        params = csv_parameters.copy()
        params.update(
            {
                "include_headers": "False",
        ...
        out_path = convert_to_csv.edi_convert(
            temp_file, os.path.join(temp_dir, "out"), settings_dict, params, {}
        )
