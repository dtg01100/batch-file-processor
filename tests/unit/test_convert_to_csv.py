...
class TestConvertToCSVUPCCalculation(TestConvertToCSVFixtures):
    ...
    def test_upc_check_digit_calculation_toggled(
        self,
        complete_edi_content,
        default_parameters,
        default_settings,
    ...
    def test_upc_check_digit_calculation_enabled(
        self,
        complete_edi_content,
        default_parameters,
        default_settings,
...
class TestConvertToCSVOverrideUPC(TestConvertToCSVFixtures):
    ...
    def test_override_upc_with_category_filter(
        self,
        complete_edi_content,
        default_parameters,
        default_settings,
    ...
    def test_override_upc_category_filter_mismatch(
        self,
        complete_edi_content,
        default_parameters,
        default_settings,
        ...
        default_parameters["override_upc_category_filter"] = (
            "CAT_NOT_EXIST"  # Non-existent category
        )
...
class TestConvertToCSVFilterAmpersand(TestConvertToCSVFixtures):
    ...
    def test_filter_ampersand_enabled(
        self,
        edi_content_with_ampersand,
        default_parameters,
        default_settings,
        empty_upc_lut,
        tmp_path,
    ...
    def test_filter_ampersand_disabled(
        self,
        edi_content_with_ampersand,
        default_parameters,
        default_settings,
...
class TestConvertToCSVRetailUOM(TestConvertToCSVFixtures):
    ...
    def test_retail_uom_with_zero_multiplier(
        self,
        sample_header_record,
        default_parameters,
        default_settings,
...
class TestConvertToCSVUPCTargetLength(TestConvertToCSVFixtures):
    ...
    def test_upc_padding_pattern_custom(
        self,
        complete_edi_content,
        default_parameters,
        default_settings,
...
class TestConvertToCSVEdgeCases(TestConvertToCSVFixtures):
    ...
    def test_empty_edi_file(
        self, default_parameters, default_settings, empty_upc_lut, tmp_path
    ):
    ...
    def test_detail_with_missing_fields(
        self, default_parameters, default_settings, empty_upc_lut, tmp_path
    ):
...
class TestConvertToCSVDataTransformation(TestConvertToCSVFixtures):
    ...
    def test_quantity_zero_stripping(
        self,
        complete_edi_content,
        default_parameters,
        default_settings,
    ...
    def test_item_number_zero_stripping(
        self,
        complete_edi_content,
        default_parameters,
        default_settings,
