...
class TestInvFetcher:
    ...
    def test_fetch_po_handles_tuple_results(self, fetcher):
        ...
        fetcher._query_runner.run_query.return_value = [("PO123", "Customer Name", 456)]
    ...
    def test_fetch_uom_desc_caches_uom_lut(self, fetcher):
        ...
        fetcher._query_runner.run_query.return_value = [{"BUHUNB": 1, "BUHXTX": "EACH"}]
    ...
    def test_fetch_uom_desc_resets_on_new_invoice(self, fetcher):
        ...
        # New invoice
        fetcher._query_runner.run_query.return_value = [{"BUHUNB": 1, "BUHXTX": "CASE"}]
    ...
    def test_fetch_uom_desc_handles_tuple_results(self, fetcher):
        ...
        fetcher._query_runner.run_query.return_value = [(1, "EACH"), (2, "CASE")]
