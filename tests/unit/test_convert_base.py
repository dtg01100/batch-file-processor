...
class MockCSVConverter(CSVConverter):
    """Mock CSV converter for testing CSVConverter base class."""

    PLUGIN_ID = "mock_csv"
    PLUGIN_NAME = "Mock CSV Converter"
    PLUGIN_DESCRIPTION = "Test CSV converter"
    CONFIG_FIELDS = []
...
class MockDBEnabledConverter(DBEnabledConverter):
    """Mock DB-enabled converter for testing DBEnabledConverter base class."""

    PLUGIN_ID = "mock_db"
    PLUGIN_NAME = "Mock DB Converter"
    PLUGIN_DESCRIPTION = "Test DB converter"
    CONFIG_FIELDS = []
...
class TestBaseConverter(unittest.TestCase):
    ...
    def test_convert_to_price(self):
        ...
        self.assertEqual(BaseConverter.convert_to_price("99"), "0.99")
        self.assertEqual(BaseConverter.convert_to_price("12345"), "123.45")
...
class TestDBEnabledConverter(unittest.TestCase):
    ...
    def test_connect_db_lazy_initialization(self, mock_query_runner):
        ...
        converter = MockDBEnabledConverter(
            self.edi_file,
            self.output_file,
            self.settings,
            self.parameters,
    ...
    def test_run_query_connects_db(self, mock_query_runner):
        ...
        self.assertTrue(converter._db_connected)
        mock_query_instance.run_arbitrary_query.assert_called_once_with(
            "SELECT * FROM test"
        )
...
class TestBaseConverterStaticMethods(unittest.TestCase):
    ...
    def test_convert_to_price_edge_cases(self):
        ...
        self.assertEqual(BaseConverter.convert_to_price(None), "0.00")
