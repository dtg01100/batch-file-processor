    ...
    def test_complete_roundtrip(self):
        ...
        original = FolderConfiguration(
            ...
            email=EmailConfiguration(
                recipients="test@example.com", subject_line="Test Subject"
            ),
        ...
        assert (
            reconstructed.copy.destination_directory
            == original.copy.destination_directory
        )
        ...
        assert (
            reconstructed.edi.split_edi_include_invoices
            == original.edi.split_edi_include_invoices
        )
        assert (
            reconstructed.edi.split_edi_include_credits
            == original.edi.split_edi_include_credits
        )
        ...
        assert (
            reconstructed.edi.force_edi_validation == original.edi.force_edi_validation
        )
        assert reconstructed.edi.rename_file == original.edi.rename_file
        assert (
            reconstructed.edi.split_edi_filter_categories
            == original.edi.split_edi_filter_categories
        )
        assert (
            reconstructed.edi.split_edi_filter_mode
            == original.edi.split_edi_filter_mode
        )
        ...
        assert (
            reconstructed.upc_override.category_filter
            == original.upc_override.category_filter
        )
        assert (
            reconstructed.upc_override.target_length
            == original.upc_override.target_length
        )
        assert (
            reconstructed.upc_override.padding_pattern
            == original.upc_override.padding_pattern
        )

        # Verify A-Record
        assert reconstructed.a_record_padding is not None
        assert (
            reconstructed.a_record_padding.enabled == original.a_record_padding.enabled
        )
        assert (
            reconstructed.a_record_padding.padding_text
            == original.a_record_padding.padding_text
        )
        assert (
            reconstructed.a_record_padding.padding_length
            == original.a_record_padding.padding_length
        )
        assert (
            reconstructed.a_record_padding.append_text
            == original.a_record_padding.append_text
        )
        assert (
            reconstructed.a_record_padding.append_enabled
            == original.a_record_padding.append_enabled
        )
        assert (
            reconstructed.a_record_padding.force_txt_extension
            == original.a_record_padding.force_txt_extension
        )
        ...
        assert (
            reconstructed.invoice_date.custom_format_enabled
            == original.invoice_date.custom_format_enabled
        )
        assert (
            reconstructed.invoice_date.custom_format_string
            == original.invoice_date.custom_format_string
        )
        ...
        assert (
            reconstructed.backend_specific.estore_store_number
            == original.backend_specific.estore_store_number
        )
        assert (
            reconstructed.backend_specific.estore_vendor_oid
            == original.backend_specific.estore_vendor_oid
        )
        assert (
            reconstructed.backend_specific.estore_vendor_namevendoroid
            == original.backend_specific.estore_vendor_namevendoroid
        )
        assert (
            reconstructed.backend_specific.fintech_division_id
            == original.backend_specific.fintech_division_id
        )
        ...
        assert (
            reconstructed.csv.include_item_numbers == original.csv.include_item_numbers
        )
        assert (
            reconstructed.csv.include_item_description
            == original.csv.include_item_description
        )
        assert (
            reconstructed.csv.simple_csv_sort_order
            == original.csv.simple_csv_sort_order
        )
        assert (
            reconstructed.csv.split_prepaid_sales_tax_crec
