...
class TestEmailConfiguration:
    ...
    def test_validate_valid_email(self):
        ...
        config = EmailConfiguration(recipients="test@example.com")
    ...
    def test_validate_email_with_special_chars(self):
        ...
        config = EmailConfiguration(recipients="test+tag@example-domain.co.uk")
...
class TestCopyConfiguration:
    ...
    def test_custom_values(self):
        ...
        config = CopyConfiguration(destination_directory="/output/path")
...
class TestEDIConfiguration:
    ...
    def test_validate_prepend_without_split(self):
        ...
        config = EDIConfiguration(split_edi=False, prepend_date_files=True)
    ...
    def test_validate_prepend_with_split(self):
        ...
        config = EDIConfiguration(split_edi=True, prepend_date_files=True)
...
class TestUPCOverrideConfiguration:
    ...
    def test_validate_enabled_valid_filter(self):
        ...
        config = UPCOverrideConfiguration(enabled=True, category_filter="1,2,3,ALL")
...
class TestARecordPaddingConfiguration:
    ...
    def test_validate_padding_too_long(self):
        ...
        config = ARecordPaddingConfiguration(
            enabled=True, padding_text="123456789", padding_length=6
        )
    ...
    def test_validate_padding_not_six_chars(self):
        ...
        config = ARecordPaddingConfiguration(
            enabled=True, padding_text="12345", padding_length=6
        )
...
class TestFolderConfiguration:
    ...
    def test_to_dict_with_email(self):
        ...
        config = FolderConfiguration(
            ...
            email=EmailConfiguration(
                recipients="test@example.com", subject_line="Subject"
            ),
        )
    ...
    def test_to_dict_with_copy(self):
        ...
        config = FolderConfiguration(
            folder_name="test",
            process_backend_copy=True,
            copy=CopyConfiguration(destination_directory="/output/path"),
        )
