...
class TestSendBackends(unittest.TestCase):
    ...
    def test_batch_log_sender_success(self, mock_overlay, mock_smtp):
        ...
        reporting = {
            'report_email_destination': 'to@example.com'
        }
        ...
        batch_log_sender_do(settings, reporting, emails_table, sent_emails_removal_queue, time, args, root, batch_number, emails_count, total_emails, simple_output, run_summary_string)
