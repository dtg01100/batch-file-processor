...
class TestDetectInvoiceIsCredit(unittest.TestCase):
    ...
    def test_invoice_negative_total(self):
        ...
        with open(edi_file, 'w') as f:
            ...
            f.write('A123456789012345012345-00012345\n')
...
class TestDoSplitEdi(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(self.edi_file, 'w') as f:
            ...
            f.write('A123456789012345012345000012345\n')
            f.write('B1234567890Test Item 1           123450123450012345012340123\n')
            # Second invoice (negative/credit)
            f.write('A123456789112346012346-00012345\n')
            f.write('B1234567891Test Item 2           123460123460012346012340123\n')
...
class TestCaptureRecords(unittest.TestCase):
    ...
    def test_capture_a_record(self):
        ...
        self.assertEqual(result['invoice_date'], '123450')
        self.assertEqual(result['invoice_total'], '000012345')
    
    def test_capture_b_record(self):
        """Test capturing B record fields."""
        line = 'B1234567890Test Description     123450123450012345012340123'
        result = utils.capture_records(line)
