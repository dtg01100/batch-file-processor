...
class TestLogEntry:
    ...
    def test_log_entry_with_custom_name(self):
        ...
        entry = LogEntry(log_path="/tmp/test.log", log_name="custom_name.log")
    ...
    def test_log_entry_with_metadata(self):
        ...
        entry = LogEntry(
            log_path="/tmp/test.log", metadata={"batch": 1, "folder": "test"}
        )
...
class TestLogSender:
    ...
    def test_send_log_with_mock_ui(self):
        ...
        sender.send_log(
            log_content="Content", recipients=["admin@example.com"], subject="Test"
        )
    ...
    def test_send_batch_logs(self, tmp_path):
        ...
        results = sender.send_batch_logs(
            logs=logs, recipients=["admin@example.com"], subject="Batch Logs"
        )
