...
class TestSendManager:
    ...
    def test_send_all_multiple_backends(self):
        ...
        manager = SendManager(
            backends={"copy": mock_copy, "ftp": mock_ftp, "email": mock_email}
        )
        ...
        results = manager.send_all(
            {"copy", "ftp", "email"}, "/test/file.edi", params, settings
        )
...
class TestSendManagerModuleBackends:
    ...
    def test_send_via_module_copy(self, mock_import):
        ...
        params = {"process_backend_copy": True, "copy_to_directory": "/backup"}
        settings = {}
    ...
    def test_send_via_module_ftp(self, mock_import):
        ...
        params = {"process_backend_ftp": True, "ftp_server": "ftp.example.com"}
        settings = {}
    ...
    def test_send_via_module_email(self, mock_import):
        ...
        params = {"process_backend_email": True, "email_to": "user@example.com"}
        settings = {}
    ...
    def test_send_via_module_disabled_backend(self):
        ...
        params = {"process_backend_copy": False, "copy_to_directory": "/backup"}
...
class TestSendManagerIntegration:
    ...
    def test_full_send_workflow(self):
        ...
        manager = SendManager(backends={"copy": copy_backend, "ftp": ftp_backend})
    ...
    def test_partial_failure_workflow(self):
        ...
        params = {"process_backend_copy": True, "process_backend_ftp": True}
