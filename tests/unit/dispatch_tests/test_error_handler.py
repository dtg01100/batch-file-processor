...
class TestErrorHandler:
    ...
    def test_record_error_to_database(self):
        ...
        handler.record_error(
            folder="/data/input", filename="file.edi", error=Exception("Test error")
        )
...
class TestErrorHandlerEdgeCases:
    ...
    def test_empty_error_message(self):
        ...
        handler.record_error(folder="folder", filename="file", error=Exception(""))
    ...
    def test_very_long_error_message(self):
        ...
        handler.record_error(
            folder="folder", filename="file", error=Exception(long_message)
        )
