...
class TestInMemoryDatabase:
    ...
    def test_update(self):
        ...
        db.update(
            "test_table", {"id": 1, "name": "Alice", "active": False}, keys=["id"]
        )
...
class TestProcessedFilesTracker:
    ...
    def test_record_sent_file_simple(self, tracker):
        ...
        tracker.record_sent_file_simple(
            file_name="simple.txt", folder_id=2, file_checksum="def456"
        )
    ...
    def test_record_sent_file_simple_with_datetime(self, tracker):
        ...
        tracker.record_sent_file_simple(
            file_name="timed.txt", folder_id=1, file_checksum="xyz", sent_date_time=now
        )
