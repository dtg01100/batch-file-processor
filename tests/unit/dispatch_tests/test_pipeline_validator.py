...
def mock_file_system(valid_edi_content):
    ...
    return MockFileSystem({"/test/valid.edi": valid_edi_content})
...
class TestValidationResult:
    ...
    def test_is_valid_true_with_warnings(self):
        ...
        result = ValidationResult(
            is_valid=True, has_minor_errors=True, warnings=["Minor issue"]
        )
    ...
    def test_empty_strings(self):
        ...
        result = ValidationResult(is_valid=True, log_output="")
    ...
    def test_multiple_errors_and_warnings(self):
        ...
        result = ValidationResult(
            is_valid=False, has_minor_errors=True, errors=errors, warnings=warnings
        )
    ...
    def test_dataclass_immutability_of_lists(self):
        ...
        result = ValidationResult(
            is_valid=True, errors=["Error 1"], warnings=["Warning 1"]
        )
...
class TestMockValidator:
    ...
    def test_minor_errors(self):
        ...
        validator = MockValidator(
            should_pass=True, should_have_minor_errors=True, warnings=["Minor warning"]
        )
    ...
    def test_custom_warning_messages(self):
        ...
        validator = MockValidator(
            should_pass=True, should_have_minor_errors=True, warnings=custom_warnings
        )
...
class TestEDIValidationStep:
    ...
    def test_validate_with_truncated_upc(self, edi_content_truncated_upc):
        ...
        mock_fs = MockFileSystem({"/test/truncated.edi": edi_content_truncated_upc})
    ...
    def test_validate_with_blank_upc(self, edi_content_blank_upc):
        ...
        mock_fs = MockFileSystem({"/test/blank.edi": edi_content_blank_upc})
    ...
    def test_validate_with_missing_pricing(self, edi_content_missing_pricing):
        ...
        mock_fs = MockFileSystem({"/test/pricing.edi": edi_content_missing_pricing})
    ...
    def test_log_output_built_correctly(self):
        ...
        mock_validator = MockValidatorForStep(
            should_pass=False, errors=["Error 1"], log_output="Validator log content"
        )
...
class TestIntegration:
    ...
    def test_full_validation_flow_valid_file(self, valid_edi_content):
        ...
        mock_fs = MockFileSystem({"/data/input/order.edi": valid_edi_content})
        mock_error_handler = MockErrorHandler()

        step = EDIValidationStep(error_handler=mock_error_handler, file_system=mock_fs)
    ...
    def test_full_validation_flow_invalid_file(self, invalid_edi_content):
        ...
        mock_fs = MockFileSystem({"/data/input/bad.edi": invalid_edi_content})
        mock_error_handler = MockErrorHandler()
    ...
    def test_validation_integrates_with_error_handler(self):
        ...
        mock_validator = MockValidatorForStep(
            should_pass=False, errors=["Critical error", "Secondary error"]
        )
        mock_error_handler = MockErrorHandler()
    ...
    def test_mock_file_system_returns_correct_content(self, valid_edi_content):
        ...
        mock_fs = MockFileSystem({"/test/file.edi": valid_edi_content})
...
class TestEdgeCases:
    ...
    def test_unicode_content(self, valid_edi_content):
        ...
        mock_fs = MockFileSystem({"/test/unicode.edi": content})
    ...
    def test_very_long_file(self):
        ...
        content = "\n".join(lines) + "\n"
        mock_fs = MockFileSystem({"/test/large.edi": content})
    ...
    def test_mock_validator_with_none_values(self):
        ...
        validator = MockValidator(should_pass=False, errors=None, warnings=None)
    ...
    def test_file_path_with_spaces(self, valid_edi_content):
        ...
        mock_fs = MockFileSystem({"/test folder/my file.edi": valid_edi_content})
