...
class TestFTPRetryLogic:
    ...
    def test_ftp_retry_after_connect_failure(self, test_file):
    ...
    def test_ftp_retry_after_login_failure(self, test_file):
    ...
    def test_ftp_succeeds_on_third_attempt(self, test_file):
        ...
        assert "test_file.txt" in sent_cmd.lower() or "stor" in sent_cmd.lower()
        assert sent_data == b"batch file processor test data\n"

    def test_ftp_gives_up_after_10_retries(self, test_file):
    ...
    def test_ftp_no_sleep_on_first_attempt(self, test_file):
    ...
    def test_ftp_sleep_called_on_retry(self, test_file):
    ...
    def test_ftp_file_content_preserved_after_retry(self, test_file):
    ...
    def test_ftp_retry_counter_resets_between_calls(self, test_file):
        ...
        with patch("ftp_backend.time.sleep"):
            ...
            result_b = ftp_backend.do(
                FTP_PARAMS, {}, test_file, ftp_client=mock_client_b
            )

        assert result_a is True
        assert result_b is True

    def test_ftp_exactly_10_retries_succeeds(self, test_file):
    ...
    def test_ftp_storbinary_called_with_filename(self, test_file):
...
class TestEmailRetryLogic:
    ...
    def test_email_retry_after_smtp_failure(self, test_file):
    ...
    def test_email_succeeds_on_second_attempt(self, test_file):
    ...
    def test_email_gives_up_after_10_retries(self, test_file):
    ...
    def test_email_no_retries_on_success(self, test_file):
    ...
    def test_email_subject_preserved_after_retry(self, test_file):
    ...
    def test_email_exactly_10_retries_succeeds(self, test_file):
        """Exactly 10 failures followed by success should still complete."""
        mock_client = MockSMTPClient()
        for _ in range(10):
