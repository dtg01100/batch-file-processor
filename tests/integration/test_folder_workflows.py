...
class TestRealWorldWorkflows:
    ...
    def test_multi_vendor_setup_workflow(self, workspace_with_datasets):
        ...
        vendor_configs = {
            ...
            "startech": {"process_edi": 1, "tweak_edi": 0, "convert_to_format": "estore_einvoice"},
            "electronics_inc": {"process_edi": 1, "tweak_edi": 1, "convert_to_format": "fintech"},
        }
    ...
    def test_batch_migration_workflow(self, workspace_with_datasets):
        ...
        for folder in all_folders_1:
            db.folders_table.update({
                "id": folder["id"],
                "folder_name": folder["folder_name"].replace("incoming", "processing"),
            }, ["id"])
