...
class TestInputValidation:
    ...
    def test_malicious_edi_content_handling(self, secure_test_environment, pipeline_steps):
...
class TestDatabaseSecurity:
    ...
    def test_database_integrity_after_processing(self, secure_test_environment, pipeline_steps):
