...
def legacy_database_v1(tmp_path):
    ...
    cursor.execute("INSERT INTO version (id, version, os) VALUES (?, ?, ?)",
                   (1, "1", "Linux"))
    
    # Insert test data
    cursor.execute("INSERT INTO folders (folder_name, alias) VALUES (?, ?)",
...
class TestMigrationWithDataValidation:
    ...
    def test_validate_data_preserved_after_migration(self, legacy_database_v3, tmp_path):
...
class TestMigrationEdgeCases:
    ...
    def test_migrate_empty_database(self, tmp_path):
        ...
        cursor.execute("INSERT INTO settings (id, enable_email) VALUES (?, ?)",
                       (1, 0))
        
        # Insert administrative record
        cursor.execute("INSERT INTO administrative (id, copy_to_directory) VALUES (?, ?)",
                       (1, ""))
