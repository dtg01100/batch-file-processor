...
class TestFTPBackendIntegration:
    ...
    def test_empty_ftp_server(self):
        ...
        config = FolderConfiguration(
            ...
            process_backend_ftp=True,
            ftp=FTPConfiguration(
                server="", username="user", password="pass", folder="/"
            ),
        )
...
class TestEmailBackendIntegration:
    ...
    def email_config_no_sender(self):
        ...
        return FolderConfiguration(
            ...
            process_backend_email=True,
            email=EmailConfiguration(
                recipients="user@example.com", subject_line="Test Subject"
            ),
        )
    ...
    def test_empty_email_recipients(self):
        ...
        config = FolderConfiguration(
            folder_name="/test",
            process_backend_email=True,
            email=EmailConfiguration(recipients="", subject_line="Test"),
        )
...
class TestCopyBackendIntegration:
    ...
    def copy_config_deep_path(self):
        ...
        return FolderConfiguration(
            ...
            process_backend_copy=True,
            copy=CopyConfiguration(destination_directory="/output/deep/nested/path/"),
        )
    ...
    def test_empty_copy_destination(self):
        ...
        config = FolderConfiguration(
            folder_name="/test",
            process_backend_copy=True,
            copy=CopyConfiguration(destination_directory=""),
        )
...
class TestBackendToggleIntegration:
    ...
    def all_backends_enabled(self):
        ...
        return FolderConfiguration(
            ...
            email=EmailConfiguration(
                recipients="test@example.com", subject_line="Test"
            ),
    ...
    def test_backend_toggle_ftp(
        self, all_backends_enabled, only_ftp_enabled, all_backends_disabled
    ):
    ...
    def test_backend_toggle_email(
        self, all_backends_enabled, only_email_enabled, all_backends_disabled
    ):
    ...
    def test_backend_toggle_copy(
        self, all_backends_enabled, only_copy_enabled, all_backends_disabled
    ):
...
class TestSendBackendToggleBehavior:
    ...
    def test_ftp_toggle_gates_connection(self):
        ...
        config_disabled = FolderConfiguration(
            folder_name="/test", process_backend_ftp=False
        )
    ...
    def test_email_toggle_gates_sending(self):
        ...
        # Email disabled
        config_disabled = FolderConfiguration(
            folder_name="/test", process_backend_email=False
        )
    ...
    def test_copy_toggle_gates_copying(self):
        ...
        # Copy disabled
        config_disabled = FolderConfiguration(
            folder_name="/test", process_backend_copy=False
        )
    ...
    def test_toggle_with_missing_config(self):
        ...
        config_missing = FolderConfiguration(
            folder_name="/test", process_backend_ftp=True, ftp=None
        )
