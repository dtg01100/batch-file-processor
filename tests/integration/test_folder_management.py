...
class TestFolderRetrieval:
    ...
    def test_get_inactive_folders(self, workspace):
        ...
        folder_manager.add_folder(str(workspace["dirs"]["folder2"]), template_data=inactive_template)
        folder_manager.add_folder(str(workspace["dirs"]["folder3"]), template_data=inactive_template)
...
class TestEdgeCases:
    ...
    def test_update_folder_nonexistent(self, workspace):
        ...
        result = folder_manager.update_folder({"id": 99999, "folder_is_active": "False"})
        assert result is False
...
class TestDefaultsInheritance:
    ...
    def test_skip_list_fields_not_inherited(self, workspace):
        ...
        for skip_field in ["logs_directory", "errors_folder", "single_add_folder_prior"]:
