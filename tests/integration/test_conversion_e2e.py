...
@pytest.fixture
def sample_edi_content_multi(
    sample_header_record, sample_detail_record, sample_tax_record
):
...
class TestConvertToCSV:
    ...
    def test_convert_handles_empty_records(
...
class TestConvertToFintech:
    ...
    def test_convert_handles_missing_upc(
        self, edi_file, tmp_path, default_parameters_dict, default_settings_dict
    ):
...
class TestConvertToScannerware:
    ...
    def test_convert_produces_valid_output(
        self, edi_file, tmp_path, default_parameters_dict, sample_upc_lut
    ):
    ...
    def test_convert_with_txt_extension(
        self, edi_file, tmp_path, default_parameters_dict, sample_upc_lut
    ):
    ...
    def test_convert_with_date_offset(
        self, edi_file, tmp_path, default_parameters_dict, sample_upc_lut
    ):
...
class TestConvertToSimplifiedCSV:
    ...
    def test_convert_without_headers(
        self, edi_file, tmp_path, default_parameters_dict, sample_upc_lut
    ):
...
class TestConvertToEstoreEinvoice:
    ...
    def test_convert_output_filename_format(
        self, edi_file, tmp_path, default_parameters_dict, sample_upc_lut
    ):
...
class TestConvertToScansheetTypeA:
    ...
    def test_convert_produces_valid_xlsx(
        self,
        edi_file,
        tmp_path,
        default_parameters_dict,
...
class TestConversionEdgeCases:
    ...
    def test_empty_edi_file(self, tmp_path, default_parameters_dict, sample_upc_lut):
        ...
        result = convert_to_csv.edi_convert(
            str(empty_edi), output_path, {}, default_parameters_dict, sample_upc_lut
        )
...
class TestOutputFormatValidation:
    ...
    def test_price_format_conversion(
        self, edi_file, tmp_path, default_parameters_dict, sample_upc_lut
    ):
