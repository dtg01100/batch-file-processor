...
class TestSingleFolderModeIntegration:
    ...
    def test_single_folder_moves_id_to_old_id(self):
        ...
        folder_data = {"id": 123, "folder_name": "/test/folder", "alias": "Test Folder"}
    ...
    def test_single_folder_drops_table_before_and_after(self):
        ...
        assert (
            mock_single_table.drop.call_count == 1
        )  # Only the last call counts due to reassignment
...
class TestBackendVariations:
    ...
    def test_active_folder_with_no_backend(self):
        ...
        has_backend = (
            ...
            or config["process_backend_ftp"]
            or config["process_backend_email"]
        )
