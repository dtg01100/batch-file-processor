...
def mock_folder_table():
    ...
    folders = [
        {"id": 1, "alias": "Folder 1", "folder_is_active": "True", "folder_name": "/path/to/folder1"},
        {"id": 2, "alias": "Folder 2", "folder_is_active": "True", "folder_name": "/path/to/folder2"},
        {"id": 3, "alias": "Inactive 1", "folder_is_active": "False", "folder_name": "/path/to/inactive1"},
        {"id": 4, "alias": "Test Folder", "folder_is_active": "True", "folder_name": "/path/to/test"},
        {"id": 5, "alias": "Archive", "folder_is_active": "False", "folder_name": "/path/to/archive"},
    ]
...
class TestFolderListWidgetComprehensive:
    ...
    def test_disable_button_callback(self, qtbot, mock_folder_table):
        ...
        disable_button = next((b for b in disable_buttons if "<-" in b.text() or "->" in b.text()), None)
...
class TestDialogStateValidation:
    ...
    def test_edit_settings_dialog_email_validation_invalid_format(self, qtbot, monkeypatch):
