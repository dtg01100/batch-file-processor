    ...
    with open(output_filename, "wb") as f:  # open work file, overwriting old file
        for line_num, line in enumerate(
            ...
            if writeable_line.startswith("A"):
                ...
                write_invoice_date = utils.capture_records(writeable_line)[
                    "invoice_date"
                ]
                if invoice_date_offset != 0:
                    invoice_date_string = utils.capture_records(writeable_line)[
                        "invoice_date"
                    ]
...
if __name__ == "__main__":
    ...
    with tempfile.TemporaryDirectory() as workdir:
        ...
        new_outfile = edi_convert(
            infile_path, outfile_path, "CAPCDY", "True", "123456", False, 0
        )
